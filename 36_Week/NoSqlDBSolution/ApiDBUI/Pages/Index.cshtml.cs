...
namespace ApiDBUI.Pages
{
    public class IndexModel : PageModel
    {
        ...
        private async Task CreateContact()
        {
            ...
            contact.EmailAddresses.Add(new EmailAddressModel { EmailAddress = "marc@iammarcmoxey.com" });
            ...
            var response = await _client.PostAsync("https://localhost:7120/api/Contacts",
        ...
        {
            var _client = _httpClientFactory.CreateClient(); // create browser
            var response = await _client.GetAsync("https://localhost:7120/api/Contacts");
