            ...
            List<AddressModel> output = new List<AddressModel>
            {
                new AddressModel { Id = 1, ContactId = 1, City = "Scranton", State = "PA"},
                 new AddressModel { Id = 2, ContactId = 1, City = "Virginia Beach", State = "VA"},
                  ...
                  new AddressModel { Id = 4, ContactId = 5, City = "Scranton", State = "PA"},
                 new AddressModel { Id = 5, ContactId = 5, City = "Virginia Beach", State = "VA"},
                  new AddressModel { Id = 6, ContactId = 4, City = "Philadelphia", State = "PA"},
